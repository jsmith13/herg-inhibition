...
Predictor ($X_i$) | Coefficient ($\beta_i$)
----------- | ---------
(intercept) | -4.49
Aromatic Atoms | 0.107
VABC Volume | 0.0156
VABC Volume$^2$ | -1.09e-5
Amine | 0.362
TPSA | -0.0180
TPSA$^2$ | 1.60e-5
XLogP | 0.0781
...
Second, the NCATS CGC dataset used to generate the model classifies compounds with weak hERG activity as "inconclusive". While we elected to treat these compounds as hERG active in order to fit within the strict success/failure outcomes of logistic regression, a multinomial regression approach may improve model performance by harnessing this additional information.
